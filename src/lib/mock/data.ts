...
export const mockFunnelMap = {
  ...
  name: 'Primary Checkout Flow',
  nodes: [
    { id: 'n1', label: 'Homepage', url: '/', type: 'page' as const, nodeCategory: 'landing_page', volume: 15000, spend: 2500, position: { x: 0, y: 0 } },
    { id: 'n2', label: 'Product Listing', url: '/products', type: 'page' as const, nodeCategory: 'sales_page', volume: 8000, spend: 1200, campaign: 'Spring Sale 2024', campaignId: 'camp-001', position: { x: 250, y: -50 } },
    { id: 'n3', label: 'Product Detail', url: '/products/:id', type: 'page' as const, nodeCategory: 'sales_page', volume: 4500, spend: 800, position: { x: 500, y: -50 } },
    { id: 'n4', label: 'Add to Cart', url: '/cart', type: 'event' as const, nodeCategory: 'add_to_cart', volume: 2800, spend: 0, position: { x: 750, y: -100 } },
    { id: 'n5', label: 'Begin Checkout', url: '/checkout', type: 'page' as const, nodeCategory: 'checkout', volume: 1800, spend: 0, position: { x: 1000, y: -100 } },
    { id: 'n6', label: 'Payment Info', url: '/checkout/payment', type: 'page' as const, nodeCategory: 'checkout', volume: 1200, spend: 0, position: { x: 1250, y: -100 } },
    { id: 'n7', label: 'Purchase Complete', url: '/checkout/confirmation', type: 'conversion' as const, nodeCategory: 'purchase', volume: 850, spend: 0, position: { x: 1500, y: -100 } },
    { id: 'n8', label: 'Browse Categories', url: '/categories', type: 'page' as const, nodeCategory: 'landing_page', volume: 3000, spend: 500, position: { x: 500, y: 100 } },
  ] as FunnelNodeData[],
  edges: [
