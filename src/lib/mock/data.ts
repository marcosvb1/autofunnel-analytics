...
export const mockFunnelMap = {
  ...
  edges: [
    ...
    { id: 'e3', source: 'n2', target: 'n3', volume: 4500, conversion: 56.25, spend: 800, isMainPath: true },
    { id: 'e4', source: 'n8', target: 'n3', volume: 1200, conversion: 40, spend: 0, isMainPath: false },
    { id: 'e5', source: 'n3', target: 'n4', volume: 2800, conversion: 62.2, spend: 0, isMainPath: true },
